Eseguire query SQL con JDBC significa essenzialmente utilizzare le classi `Statement`, `PreparedStatement` e `ResultSet` delle API all’interno di codice Java.
